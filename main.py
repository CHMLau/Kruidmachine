...
while True:
    ...
    mycursor.execute("SELECT hoeveelheid1 FROM mix WHERE maken = 'ja';")
	...
	time.sleep(8)
    mycursor.execute("SELECT hoeveelheid2 FROM mix WHERE maken = 'ja';")
    ...
    mycursor.execute("SELECT hoeveelheid3 FROM mix WHERE maken = 'ja';")
